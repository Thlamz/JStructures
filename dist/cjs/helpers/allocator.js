...
exports.RepeatAllocator = exports.UniqueAllocator = void 0;
...
exports.UniqueAllocator = UniqueAllocator;
class RepeatAllocator {
    constructor() {
        this.pointer = 0;
        this.pointerSpace = [];
        this.freePointers = [];
...
exports.RepeatAllocator = RepeatAllocator;
